...
Aplicação web desenvolvida com o objetivo de realizar o gerenciamento simplificado de documentos, permitindo upload de arquivos, listagem e um histórico de comentários para cada item.
...
```bash
    git clone https://github.com/renatoyx/gestao-documentos.git
    cd gestao-documento
```
2. No Windows:
```bash 
